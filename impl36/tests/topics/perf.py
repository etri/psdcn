...
def init(publication):
    ...
    for i in range(5000):
        publication.advertise("/etri/bldg3/room628/" + str(i), "rn1")

def test_matches(publication, verbose=True):
    for match in publication.matches("/etri/bldg7/room318/100"):
        pass
    """
    for match in publication.matches("/etri/bldg7/+/+"):
        pass
    for match in publication.matches("/etri/#"):
        pass
    for match in publication.matches("/nowhere/+/+"):
        pass
    """
...
if __name__ == "__main__":
    ...
    init(publisher)
    print("Done publishing. # of datanames is", publisher.count())
    start = time()
    algorithm += "()"
